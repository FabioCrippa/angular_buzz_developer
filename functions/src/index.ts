...
const stripe = new Stripe(process.env.STRIPE_SECRET_KEY || 'sk_test_51SSO1CPeMRCkgPBhhTGAFm950miNFGoiM3lmHquSOEtUj9vWK68NB2fbPMRqzS4PxHTThtnaUWrrUeDecYfV18ai00lpSDQElH', {
  apiVersion: '2025-10-29.clover' // updated to supported API version
});
...
app.post('/api/v1/payments/create-checkout', async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'subscription',
      success_url: req.body.successUrl || 'https://sowlfy.web.app/payment/success?session_id={CHECKOUT_SESSION_ID}',
      cancel_url: req.body.cancelUrl || 'https://sowlfy.web.app/payment/cancel',
      metadata: {
